...
public class mapsidejoin {
	public static class mapsidemapper extends Mapper<LongWritable,Text,Text,Text>
	{
		...
		
		{
		    ...
		    job.setJobName("Mapside join");
		    job.addCacheFile(new Path("/niit/salary.txt").toUri());
		    job.addCacheFile(new Path("/niit/desig.txt").toUri());
